package spjportal;
	...
	public class coursefilter {
		static Logger log = LogManager.getLogger(coursefilter.class);
		@Test(priority=2)
		public void coursefiltertype(Method method) throws InterruptedException {
			System.out.println("\n Welcome \n");
		     ...
		     WebDriverManager.chromedriver().setup();
				...
				Reporter.log( "Maximize the Browser", true );
		         ...
		         System.out.println("The number of Record  is from term and course in filter "+ row.size());
		         log.info("The number of Record  is from term and course in filter"+ row.size());
		 		...
		 		Reporter.log("Login to the WorkBench",true);
		 		 driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div[2]/div[3]/form/div[1]/div/input[1]")).sendKeys(" implementations@ken42.spj.playground");
		 			...
		 			Reporter.log("Clear the Extra API On the URI ",true);
		 			 driver.findElement(By.xpath("/html/body/div[2]/form/input[2]")).sendKeys("/services/apexrest/TimeTable/?termName=BBA Term 1 Master&course=BBALIB106-World Cultures");
		 			  log.info("on the api Testing Here We fillter the term in BBA Term 1 and course World Cultures");
		 			 Reporter.log("on the api Testing Here We fillter term in BBA Term 1 and course World Cultures ",true);
