package spjportal;
	...
	public class sendmail {
		...
		@Test(priority=2)
		public void sendmailtostudents(Method method) throws InterruptedException {
			System.out.println("\n Welcome \n");
		     ...
		     WebDriverManager.chromedriver().setup();
				...
				Reporter.log( "Maximize the Browser", true );
		         ...
		         driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/div[2]/div/div/div[3]/div/table/tbody/tr[1]/td[12]/div/div/button[2]")).click();
		         Thread.sleep(5000);
